-- Set mapleader to space
    vim.g.mapleader = " " -- Define key mappings
...
vim.keymap.set('n', 'fl', function() vim.cmd('Telescope buffers') end) vim.keymap.set('n', 'fh', function() vim.cmd('Telescope help_tags') end)
